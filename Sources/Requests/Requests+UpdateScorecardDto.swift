...
extension Requests {
    public struct UpdateScorecardDto: Codable, Hashable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.metrics = try container.decodeIfPresent([ScorecardMetric].self, forKey: .metrics)
