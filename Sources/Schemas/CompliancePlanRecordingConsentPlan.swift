...
public enum CompliancePlanRecordingConsentPlan: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch discriminant {
        case "stay-on-line":
            self = .stayOnLine(try StayOnLine(from: decoder))
        case "verbal":
            self = .verbal(try Verbal(from: decoder))
        default:
    ...
    public struct StayOnLine: Codable, Hashable, Sendable {
        public let type: String = "stay-on-line"
    ...
    public struct Verbal: Codable, Hashable, Sendable {
        public let type: String = "verbal"
        /// This is the message asking for consent to record the call.
        /// If the type is `stay-on-line`, the message should ask the user to hang up if they do not consent.
        /// If the type is `verbal`, the message should ask the user to verbally consent or decline.
        public let message: String
