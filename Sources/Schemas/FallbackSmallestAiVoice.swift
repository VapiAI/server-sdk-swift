...
public struct FallbackSmallestAiVoice: Codable, Hashable, Sendable {
    ...
    public let model: FallbackSmallestAiVoiceModel?
    ...
    public init(
        ...
        model: FallbackSmallestAiVoiceModel? = nil,
        speed: Double? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.model = try container.decodeIfPresent(FallbackSmallestAiVoiceModel.self, forKey: .model)
