...
public enum ServerMessageEndOfCallReportEndedReason: String, Codable, Hashable, CaseIterable, Sendable {
    ...
    case callStartAssistantVersionErrorValidation = "call.start.assistant-version-error-validation"
    case callStartSquadVersionErrorValidation = "call.start.squad-version-error-validation"
    ...
    case pipelineErrorVapiVoiceFailed = "pipeline-error-vapi-voice-failed"
    ...
    case pipelineErrorWellsaidVoiceFailed = "pipeline-error-wellsaid-voice-failed"
    case pipelineErrorXaiVoiceFailed = "pipeline-error-xai-voice-failed"
    case pipelineErrorMicrosoftVoiceFailed = "pipeline-error-microsoft-voice-failed"
    case pipelineErrorMicrosoftVoiceRequestCanceled = "pipeline-error-microsoft-voice-request-canceled"
    ...
    case callInProgressErrorVapifaultVapiVoiceFailed = "call.in-progress.error-vapifault-vapi-voice-failed"
    ...
    case callInProgressErrorVapifaultWellsaidVoiceFailed = "call.in-progress.error-vapifault-wellsaid-voice-failed"
    case callInProgressErrorVapifaultXaiVoiceFailed = "call.in-progress.error-vapifault-xai-voice-failed"
    case callInProgressErrorVapifaultMicrosoftVoiceFailed = "call.in-progress.error-vapifault-microsoft-voice-failed"
    ...
    case callInProgressErrorVapifaultVapiLlmFailed = "call.in-progress.error-vapifault-vapi-llm-failed"
    ...
    case pipelineErrorVapiTranscriberFailed = "pipeline-error-vapi-transcriber-failed"
    case callInProgressErrorVapifaultVapiTranscriberFailed = "call.in-progress.error-vapifault-vapi-transcriber-failed"
    case callInProgressErrorProviderfaultVapiTranscriberFailed = "call.in-progress.error-providerfault-vapi-transcriber-failed"
    case callInProgressErrorProviderfaultVapiVoiceFailed = "call.in-progress.error-providerfault-vapi-voice-failed"
    ...
    case pipelineErrorSonioxTranscriberAuthFailed = "pipeline-error-soniox-transcriber-auth-failed"
    case pipelineErrorSonioxTranscriberRateLimited = "pipeline-error-soniox-transcriber-rate-limited"
    case pipelineErrorSonioxTranscriberInvalidConfig = "pipeline-error-soniox-transcriber-invalid-config"
    case pipelineErrorSonioxTranscriberServerError = "pipeline-error-soniox-transcriber-server-error"
    case pipelineErrorSonioxTranscriberFailed = "pipeline-error-soniox-transcriber-failed"
    case callInProgressErrorVapifaultSonioxTranscriberAuthFailed = "call.in-progress.error-vapifault-soniox-transcriber-auth-failed"
    case callInProgressErrorVapifaultSonioxTranscriberRateLimited = "call.in-progress.error-vapifault-soniox-transcriber-rate-limited"
    case callInProgressErrorVapifaultSonioxTranscriberInvalidConfig = "call.in-progress.error-vapifault-soniox-transcriber-invalid-config"
    case callInProgressErrorVapifaultSonioxTranscriberServerError = "call.in-progress.error-vapifault-soniox-transcriber-server-error"
    case callInProgressErrorVapifaultSonioxTranscriberFailed = "call.in-progress.error-vapifault-soniox-transcriber-failed"
    case pipelineErrorXaiTranscriberAuthFailed = "pipeline-error-xai-transcriber-auth-failed"
    case pipelineErrorXaiTranscriberRateLimited = "pipeline-error-xai-transcriber-rate-limited"
    case pipelineErrorXaiTranscriberInvalidConfig = "pipeline-error-xai-transcriber-invalid-config"
    case pipelineErrorXaiTranscriberServerError = "pipeline-error-xai-transcriber-server-error"
    case pipelineErrorXaiTranscriberFailed = "pipeline-error-xai-transcriber-failed"
    case callInProgressErrorVapifaultXaiTranscriberAuthFailed = "call.in-progress.error-vapifault-xai-transcriber-auth-failed"
    case callInProgressErrorVapifaultXaiTranscriberRateLimited = "call.in-progress.error-vapifault-xai-transcriber-rate-limited"
    case callInProgressErrorVapifaultXaiTranscriberInvalidConfig = "call.in-progress.error-vapifault-xai-transcriber-invalid-config"
    case callInProgressErrorVapifaultXaiTranscriberServerError = "call.in-progress.error-vapifault-xai-transcriber-server-error"
    case callInProgressErrorVapifaultXaiTranscriberFailed = "call.in-progress.error-vapifault-xai-transcriber-failed"
    case pipelineErrorCartesiaTranscriberFailed = "pipeline-error-cartesia-transcriber-failed"
    case callInProgressErrorVapifaultCartesiaTranscriberFailed = "call.in-progress.error-vapifault-cartesia-transcriber-failed"
    ...
    case callInProgressErrorProviderfaultMinimaxLlmFailed = "call.in-progress.error-providerfault-minimax-llm-failed"
    ...
    case callInProgressErrorProviderfaultBasetenLlmFailed = "call.in-progress.error-providerfault-baseten-llm-failed"
    ...
    case callInProgressErrorConfigfaultModelUnsupportedInSquad = "call.in-progress.error-configfault-model-unsupported-in-squad"
    case callInProgressErrorConfigfaultTransportUnsupportedForModel = "call.in-progress.error-configfault-transport-unsupported-for-model"
    ...
    case pipelineErrorBaseten400BadRequestValidationFailed = "pipeline-error-baseten-400-bad-request-validation-failed"
    case pipelineErrorBaseten401Unauthorized = "pipeline-error-baseten-401-unauthorized"
    case pipelineErrorBaseten403ModelAccessDenied = "pipeline-error-baseten-403-model-access-denied"
    case pipelineErrorBaseten429ExceededQuota = "pipeline-error-baseten-429-exceeded-quota"
    case pipelineErrorBaseten500ServerError = "pipeline-error-baseten-500-server-error"
    case pipelineErrorBaseten503ServerOverloadedError = "pipeline-error-baseten-503-server-overloaded-error"
    case pipelineErrorBasetenLlmFailed = "pipeline-error-baseten-llm-failed"
    case callInProgressErrorVapifaultBaseten400BadRequestValidationFailed = "call.in-progress.error-vapifault-baseten-400-bad-request-validation-failed"
    case callInProgressErrorVapifaultBaseten401Unauthorized = "call.in-progress.error-vapifault-baseten-401-unauthorized"
    case callInProgressErrorVapifaultBaseten403ModelAccessDenied = "call.in-progress.error-vapifault-baseten-403-model-access-denied"
    case callInProgressErrorVapifaultBaseten429ExceededQuota = "call.in-progress.error-vapifault-baseten-429-exceeded-quota"
    case callInProgressErrorProviderfaultBaseten500ServerError = "call.in-progress.error-providerfault-baseten-500-server-error"
    case callInProgressErrorProviderfaultBaseten503ServerOverloadedError = "call.in-progress.error-providerfault-baseten-503-server-overloaded-error"
    ...
    case pipelineErrorMinimax400BadRequestValidationFailed = "pipeline-error-minimax-400-bad-request-validation-failed"
    case pipelineErrorMinimax401Unauthorized = "pipeline-error-minimax-401-unauthorized"
    case pipelineErrorMinimax403ModelAccessDenied = "pipeline-error-minimax-403-model-access-denied"
    case pipelineErrorMinimax429ExceededQuota = "pipeline-error-minimax-429-exceeded-quota"
    case pipelineErrorMinimax500ServerError = "pipeline-error-minimax-500-server-error"
    case pipelineErrorMinimax503ServerOverloadedError = "pipeline-error-minimax-503-server-overloaded-error"
    case pipelineErrorMinimaxLlmFailed = "pipeline-error-minimax-llm-failed"
    case callInProgressErrorVapifaultMinimax400BadRequestValidationFailed = "call.in-progress.error-vapifault-minimax-400-bad-request-validation-failed"
    case callInProgressErrorVapifaultMinimax401Unauthorized = "call.in-progress.error-vapifault-minimax-401-unauthorized"
    case callInProgressErrorVapifaultMinimax403ModelAccessDenied = "call.in-progress.error-vapifault-minimax-403-model-access-denied"
    case callInProgressErrorVapifaultMinimax429ExceededQuota = "call.in-progress.error-vapifault-minimax-429-exceeded-quota"
    case callInProgressErrorProviderfaultMinimax500ServerError = "call.in-progress.error-providerfault-minimax-500-server-error"
    case callInProgressErrorProviderfaultMinimax503ServerOverloadedError = "call.in-progress.error-providerfault-minimax-503-server-overloaded-error"
    ...
    case callInProgressErrorPipelineWsModelConnectionFailed = "call.in-progress.error-pipeline-ws-model-connection-failed"
    ...
    case callInProgressErrorProviderfaultElevenLabsSystemBusyAndRequestedUpgrade = "call.in-progress.error-providerfault-eleven-labs-system-busy-and-requested-upgrade"
    ...
    case customerEndedCallDuringTransfer = "customer-ended-call-during-transfer"
    ...
    case callForwardingNoAnswer = "call.forwarding.no-answer"
    ...
    case callInProgressErrorProviderfaultOutboundSip408RequestTimeout = "call.in-progress.error-providerfault-outbound-sip-408-request-timeout"
    ...
    case sipOutboundUnallocatedNumber = "sip-outbound-unallocated-number"
    case sipOutboundCarrierReleasedCall = "sip-outbound-carrier-released-call"
