...
public struct InsightTimeRangeWithStep: Codable, Hashable, Sendable {
    ...
    public let step: InsightTimeRangeWithStepStep?
    ...
    public init(
        step: InsightTimeRangeWithStepStep? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.step = try container.decodeIfPresent(InsightTimeRangeWithStepStep.self, forKey: .step)
