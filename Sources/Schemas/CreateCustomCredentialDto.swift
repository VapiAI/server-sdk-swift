...
public struct CreateCustomCredentialDto: Codable, Hashable, Sendable {
    ...
    public let encryptionPlan: CreateCustomCredentialDtoEncryptionPlan?
    ...
    public init(
        ...
        encryptionPlan: CreateCustomCredentialDtoEncryptionPlan? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.encryptionPlan = try container.decodeIfPresent(CreateCustomCredentialDtoEncryptionPlan.self, forKey: .encryptionPlan)
