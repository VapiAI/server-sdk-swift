...
public struct S3CompatibleStorageCredential: Codable, Hashable, Sendable {
    /// This is for S3-compatible storage such as MinIO, Garage, Ceph, or Backblaze B2.
    public let provider: S3CompatibleStorageCredentialProvider
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.provider = try container.decode(S3CompatibleStorageCredentialProvider.self, forKey: .provider)
