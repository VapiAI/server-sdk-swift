...
public struct ToolCallResult: Codable, Hashable, Sendable {
    ...
    public let message: ToolCallResultSpokenMessage?
    ...
    public init(
        message: ToolCallResultSpokenMessage? = nil,
        name: String,
        toolCallId: String,
        result: String? = nil,
        error: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.message = try container.decodeIfPresent(ToolCallResultSpokenMessage.self, forKey: .message)
