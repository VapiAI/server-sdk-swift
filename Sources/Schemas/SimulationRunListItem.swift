...
public struct SimulationRunListItem: Codable, Hashable, Sendable {
    /// Unique identifier for the run
    public let id: String
    /// Organization ID
    public let orgId: String
    /// Current status of the run
    public let status: SimulationRunListItemStatus
    ...
    public let simulations: [SimulationRunListItemSimulationsItem]
    /// Target to test against
    public let target: SimulationRunListItemTarget
    ...
    public let summary: SimulationRunListSummary
    ...
    public init(
        id: String,
        orgId: String,
        status: SimulationRunListItemStatus,
        queuedAt: Date,
        startedAt: Date? = nil,
        endedAt: Date? = nil,
        ...
        simulations: [SimulationRunListItemSimulationsItem],
        target: SimulationRunListItemTarget,
        iterations: Double? = nil,
        transport: SimulationRunTransportConfiguration? = nil,
        summary: SimulationRunListSummary,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(SimulationRunListItemStatus.self, forKey: .status)
        ...
        self.simulations = try container.decode([SimulationRunListItemSimulationsItem].self, forKey: .simulations)
        self.target = try container.decode(SimulationRunListItemTarget.self, forKey: .target)
        ...
        self.summary = try container.decode(SimulationRunListSummary.self, forKey: .summary)
