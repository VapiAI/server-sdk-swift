...
public struct CreateSipRequestToolDto: Codable, Hashable, Sendable {
    ...
    public let body: CreateSipRequestToolDtoBody?
    ...
    public init(
        messages: [CreateSipRequestToolDtoMessagesItem]? = nil,
        verb: CreateSipRequestToolDtoVerb,
        headers: JsonSchema? = nil,
        body: CreateSipRequestToolDtoBody? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.messages = try container.decodeIfPresent([CreateSipRequestToolDtoMessagesItem].self, forKey: .messages)
        self.verb = try container.decode(CreateSipRequestToolDtoVerb.self, forKey: .verb)
        self.headers = try container.decodeIfPresent(JsonSchema.self, forKey: .headers)
        self.body = try container.decodeIfPresent(CreateSipRequestToolDtoBody.self, forKey: .body)
