...
public struct BarInsightFromCallTable: Codable, Hashable, Sendable {
    /// This is the name of the Insight.
    public let name: String?
    /// This is the type of the Insight.
    /// It is required to be `bar` to create a bar insight.
    public let type: BarInsightFromCallTableType
    ...
    public let groupBy: BarInsightFromCallTableGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [BarInsightFromCallTableQueriesItem]
    ...
    public init(
        ...
        groupBy: BarInsightFromCallTableGroupBy? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(BarInsightFromCallTableType.self, forKey: .type)
        ...
        self.groupBy = try container.decodeIfPresent(BarInsightFromCallTableGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([BarInsightFromCallTableQueriesItem].self, forKey: .queries)
