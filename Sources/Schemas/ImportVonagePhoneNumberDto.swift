...
public struct ImportVonagePhoneNumberDto: Codable, Hashable, Sendable {
    ...
    public let fallbackDestination: ImportVonagePhoneNumberDtoFallbackDestination?
    /// This is the hooks that will be used for incoming calls to this phone number.
    public let hooks: [ImportVonagePhoneNumberDtoHooksItem]?
    /// These are the digits of the phone number you own on your Vonage.
    public let vonagePhoneNumber: String
    ...
    public init(
        fallbackDestination: ImportVonagePhoneNumberDtoFallbackDestination? = nil,
        hooks: [ImportVonagePhoneNumberDtoHooksItem]? = nil,
        ...
        self.hooks = hooks
        self.vonagePhoneNumber = vonagePhoneNumber
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.fallbackDestination = try container.decodeIfPresent(ImportVonagePhoneNumberDtoFallbackDestination.self, forKey: .fallbackDestination)
        self.hooks = try container.decodeIfPresent([ImportVonagePhoneNumberDtoHooksItem].self, forKey: .hooks)
        self.vonagePhoneNumber = try container.decode(String.self, forKey: .vonagePhoneNumber)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.vonagePhoneNumber, forKey: .vonagePhoneNumber)
