...
public enum UpdateAssistantDraftDtoVoicemailDetection: Codable, Hashable, Sendable {
    ...
    case updateAssistantDraftDtoVoicemailDetectionZero(UpdateAssistantDraftDtoVoicemailDetectionZero)
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if let value = try? container.decode(UpdateAssistantDraftDtoVoicemailDetectionZero.self) {
            self = .updateAssistantDraftDtoVoicemailDetectionZero(value)
