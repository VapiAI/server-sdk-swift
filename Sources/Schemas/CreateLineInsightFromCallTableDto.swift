...
public struct CreateLineInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let groupBy: CreateLineInsightFromCallTableDtoGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [CreateLineInsightFromCallTableDtoQueriesItem]
    ...
    public init(
        ...
        groupBy: CreateLineInsightFromCallTableDtoGroupBy? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(CreateLineInsightFromCallTableDtoGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([CreateLineInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
