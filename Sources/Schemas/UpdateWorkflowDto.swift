...
public struct UpdateWorkflowDto: Codable, Hashable, Sendable {
    ...
    public let backgroundSound: UpdateWorkflowDtoBackgroundSound?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [UpdateWorkflowDtoHooksItem]?
    ...
    public let credentials: [UpdateWorkflowDtoCredentialsItem]?
    /// This is the voicemail detection plan for the workflow.
    public let voicemailDetection: UpdateWorkflowDtoVoicemailDetection?
    ...
    public init(
        nodes: [UpdateWorkflowDtoNodesItem]? = nil,
        model: UpdateWorkflowDtoModel? = nil,
        transcriber: UpdateWorkflowDtoTranscriber? = nil,
        voice: UpdateWorkflowDtoVoice? = nil,
        observabilityPlan: LangfuseObservabilityPlan? = nil,
        backgroundSound: UpdateWorkflowDtoBackgroundSound? = nil,
        hooks: [UpdateWorkflowDtoHooksItem]? = nil,
        credentials: [UpdateWorkflowDtoCredentialsItem]? = nil,
        voicemailDetection: UpdateWorkflowDtoVoicemailDetection? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.nodes = try container.decodeIfPresent([UpdateWorkflowDtoNodesItem].self, forKey: .nodes)
        self.model = try container.decodeIfPresent(UpdateWorkflowDtoModel.self, forKey: .model)
        self.transcriber = try container.decodeIfPresent(UpdateWorkflowDtoTranscriber.self, forKey: .transcriber)
        self.voice = try container.decodeIfPresent(UpdateWorkflowDtoVoice.self, forKey: .voice)
        self.observabilityPlan = try container.decodeIfPresent(LangfuseObservabilityPlan.self, forKey: .observabilityPlan)
        self.backgroundSound = try container.decodeIfPresent(UpdateWorkflowDtoBackgroundSound.self, forKey: .backgroundSound)
        self.hooks = try container.decodeIfPresent([UpdateWorkflowDtoHooksItem].self, forKey: .hooks)
        self.credentials = try container.decodeIfPresent([UpdateWorkflowDtoCredentialsItem].self, forKey: .credentials)
        self.voicemailDetection = try container.decodeIfPresent(UpdateWorkflowDtoVoicemailDetection.self, forKey: .voicemailDetection)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.edges, forKey: .edges)
