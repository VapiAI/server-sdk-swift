...
public struct AssistantVersion: Codable, Hashable, Sendable {
    /// These are the options for the assistant's transcriber.
    public let transcriber: AssistantVersionTranscriber?
    /// These are the options for the assistant's LLM.
    public let model: AssistantVersionModel?
    /// These are the options for the assistant's voice.
    public let voice: AssistantVersionVoice?
    ...
    public let firstMessageMode: AssistantVersionFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// By default, voicemail detection is disabled.
    public let voicemailDetection: AssistantVersionVoicemailDetection?
    ...
    public let clientMessages: [AssistantVersionClientMessagesItem]?
    ...
    public let serverMessages: [AssistantVersionServerMessagesItem]?
    ...
    public let backgroundSound: AssistantVersionBackgroundSound?
    ...
    public let credentials: [AssistantVersionCredentialsItem]?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [AssistantVersionHooksItem]?
    ...
    public init(
        transcriber: AssistantVersionTranscriber? = nil,
        model: AssistantVersionModel? = nil,
        voice: AssistantVersionVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: AssistantVersionFirstMessageMode? = nil,
        voicemailDetection: AssistantVersionVoicemailDetection? = nil,
        clientMessages: [AssistantVersionClientMessagesItem]? = nil,
        serverMessages: [AssistantVersionServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: AssistantVersionBackgroundSound? = nil,
        ...
        credentials: [AssistantVersionCredentialsItem]? = nil,
        hooks: [AssistantVersionHooksItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(AssistantVersionTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(AssistantVersionModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(AssistantVersionVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(AssistantVersionFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(AssistantVersionVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([AssistantVersionClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([AssistantVersionServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(AssistantVersionBackgroundSound.self, forKey: .backgroundSound)
        ...
        self.credentials = try container.decodeIfPresent([AssistantVersionCredentialsItem].self, forKey: .credentials)
        self.hooks = try container.decodeIfPresent([AssistantVersionHooksItem].self, forKey: .hooks)
