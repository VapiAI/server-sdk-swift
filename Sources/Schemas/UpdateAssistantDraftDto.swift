...
public struct UpdateAssistantDraftDto: Codable, Hashable, Sendable {
    /// These are the options for the assistant's transcriber.
    public let transcriber: UpdateAssistantDraftDtoTranscriber?
    /// These are the options for the assistant's LLM.
    public let model: UpdateAssistantDraftDtoModel?
    /// These are the options for the assistant's voice.
    public let voice: UpdateAssistantDraftDtoVoice?
    ...
    public let firstMessageMode: UpdateAssistantDraftDtoFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// By default, voicemail detection is disabled.
    public let voicemailDetection: UpdateAssistantDraftDtoVoicemailDetection?
    ...
    public let clientMessages: [UpdateAssistantDraftDtoClientMessagesItem]?
    ...
    public let serverMessages: [UpdateAssistantDraftDtoServerMessagesItem]?
    ...
    public let backgroundSound: UpdateAssistantDraftDtoBackgroundSound?
    ...
    public let credentials: [UpdateAssistantDraftDtoCredentialsItem]?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [UpdateAssistantDraftDtoHooksItem]?
    ...
    public init(
        transcriber: UpdateAssistantDraftDtoTranscriber? = nil,
        model: UpdateAssistantDraftDtoModel? = nil,
        voice: UpdateAssistantDraftDtoVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: UpdateAssistantDraftDtoFirstMessageMode? = nil,
        voicemailDetection: UpdateAssistantDraftDtoVoicemailDetection? = nil,
        clientMessages: [UpdateAssistantDraftDtoClientMessagesItem]? = nil,
        serverMessages: [UpdateAssistantDraftDtoServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: UpdateAssistantDraftDtoBackgroundSound? = nil,
        ...
        credentials: [UpdateAssistantDraftDtoCredentialsItem]? = nil,
        hooks: [UpdateAssistantDraftDtoHooksItem]? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(UpdateAssistantDraftDtoTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(UpdateAssistantDraftDtoModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(UpdateAssistantDraftDtoVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(UpdateAssistantDraftDtoFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(UpdateAssistantDraftDtoVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([UpdateAssistantDraftDtoClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([UpdateAssistantDraftDtoServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(UpdateAssistantDraftDtoBackgroundSound.self, forKey: .backgroundSound)
        ...
        self.credentials = try container.decodeIfPresent([UpdateAssistantDraftDtoCredentialsItem].self, forKey: .credentials)
        self.hooks = try container.decodeIfPresent([UpdateAssistantDraftDtoHooksItem].self, forKey: .hooks)
