...
public struct XaiTranscriber: Codable, Hashable, Sendable {
    ...
    public let language: XaiTranscriberLanguage?
    ...
    public init(
        model: XaiTranscriberModel? = nil,
        language: XaiTranscriberLanguage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.model = try container.decodeIfPresent(XaiTranscriberModel.self, forKey: .model)
        self.language = try container.decodeIfPresent(XaiTranscriberLanguage.self, forKey: .language)
