...
public struct AssistantDraft: Codable, Hashable, Sendable {
    /// These are the options for the assistant's transcriber.
    public let transcriber: AssistantDraftTranscriber?
    /// These are the options for the assistant's LLM.
    public let model: AssistantDraftModel?
    /// These are the options for the assistant's voice.
    public let voice: AssistantDraftVoice?
    ...
    public let firstMessageMode: AssistantDraftFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// By default, voicemail detection is disabled.
    public let voicemailDetection: AssistantDraftVoicemailDetection?
    ...
    public let clientMessages: [AssistantDraftClientMessagesItem]?
    ...
    public let serverMessages: [AssistantDraftServerMessagesItem]?
    ...
    public let backgroundSound: AssistantDraftBackgroundSound?
    ...
    public let credentials: [AssistantDraftCredentialsItem]?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [AssistantDraftHooksItem]?
    ...
    public init(
        transcriber: AssistantDraftTranscriber? = nil,
        model: AssistantDraftModel? = nil,
        voice: AssistantDraftVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: AssistantDraftFirstMessageMode? = nil,
        voicemailDetection: AssistantDraftVoicemailDetection? = nil,
        clientMessages: [AssistantDraftClientMessagesItem]? = nil,
        serverMessages: [AssistantDraftServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: AssistantDraftBackgroundSound? = nil,
        ...
        credentials: [AssistantDraftCredentialsItem]? = nil,
        hooks: [AssistantDraftHooksItem]? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(AssistantDraftTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(AssistantDraftModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(AssistantDraftVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(AssistantDraftFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(AssistantDraftVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([AssistantDraftClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([AssistantDraftServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(AssistantDraftBackgroundSound.self, forKey: .backgroundSound)
        ...
        self.credentials = try container.decodeIfPresent([AssistantDraftCredentialsItem].self, forKey: .credentials)
        self.hooks = try container.decodeIfPresent([AssistantDraftHooksItem].self, forKey: .hooks)
