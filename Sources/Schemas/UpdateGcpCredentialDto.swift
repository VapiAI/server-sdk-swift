...
public struct UpdateGcpCredentialDto: Codable, Hashable, Sendable {
    public let provider: UpdateGcpCredentialDtoProvider?
    ...
    public init(
        provider: UpdateGcpCredentialDtoProvider? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.provider = try container.decodeIfPresent(UpdateGcpCredentialDtoProvider.self, forKey: .provider)
