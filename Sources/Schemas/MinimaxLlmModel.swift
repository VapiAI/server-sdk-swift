...
public struct MinimaxLlmModel: Codable, Hashable, Sendable {
    /// This is the starting state for the conversation.
    public let messages: [OpenAiMessage]?
    /// These are the tools that the assistant can use during the call. To use existing tools, use `toolIds`.
    /// 
    /// Both `tools` and `toolIds` can be used together.
    public let tools: [MinimaxLlmModelToolsItem]?
    ...
    public let model: MinimaxLlmModelModel
    ...
    public init(
        ...
        tools: [MinimaxLlmModelToolsItem]? = nil,
        toolIds: [String]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.tools = try container.decodeIfPresent([MinimaxLlmModelToolsItem].self, forKey: .tools)
        ...
        self.model = try container.decode(MinimaxLlmModelModel.self, forKey: .model)
