...
public struct CreateWorkflowDto: Codable, Hashable, Sendable {
    ...
    public let backgroundSound: CreateWorkflowDtoBackgroundSound?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [CreateWorkflowDtoHooksItem]?
    ...
    public let credentials: [CreateWorkflowDtoCredentialsItem]?
    /// This is the voicemail detection plan for the workflow.
    public let voicemailDetection: CreateWorkflowDtoVoicemailDetection?
    ...
    public init(
        ...
        model: CreateWorkflowDtoModel? = nil,
        transcriber: CreateWorkflowDtoTranscriber? = nil,
        voice: CreateWorkflowDtoVoice? = nil,
        observabilityPlan: LangfuseObservabilityPlan? = nil,
        backgroundSound: CreateWorkflowDtoBackgroundSound? = nil,
        hooks: [CreateWorkflowDtoHooksItem]? = nil,
        credentials: [CreateWorkflowDtoCredentialsItem]? = nil,
        voicemailDetection: CreateWorkflowDtoVoicemailDetection? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.nodes = try container.decode([CreateWorkflowDtoNodesItem].self, forKey: .nodes)
        self.model = try container.decodeIfPresent(CreateWorkflowDtoModel.self, forKey: .model)
        self.transcriber = try container.decodeIfPresent(CreateWorkflowDtoTranscriber.self, forKey: .transcriber)
        self.voice = try container.decodeIfPresent(CreateWorkflowDtoVoice.self, forKey: .voice)
        self.observabilityPlan = try container.decodeIfPresent(LangfuseObservabilityPlan.self, forKey: .observabilityPlan)
        self.backgroundSound = try container.decodeIfPresent(CreateWorkflowDtoBackgroundSound.self, forKey: .backgroundSound)
        self.hooks = try container.decodeIfPresent([CreateWorkflowDtoHooksItem].self, forKey: .hooks)
        self.credentials = try container.decodeIfPresent([CreateWorkflowDtoCredentialsItem].self, forKey: .credentials)
        self.voicemailDetection = try container.decodeIfPresent(CreateWorkflowDtoVoicemailDetection.self, forKey: .voicemailDetection)
