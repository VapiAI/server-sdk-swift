...
public enum ToolsUpdateRequest: Codable, Hashable, Sendable {
    ...
    public struct ApiRequest: Codable, Hashable, Sendable {
        ...
        public let messages: [UpdateApiRequestToolDtoMessagesItem]?
        public let method: UpdateApiRequestToolDtoMethod?
        ...
        public init(
            messages: [UpdateApiRequestToolDtoMessagesItem]? = nil,
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateApiRequestToolDtoMessagesItem].self, forKey: .messages)
    ...
    public struct EndCall: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateEndCallToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateEndCallToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateEndCallToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct Function: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateFunctionToolDtoMessagesItem]?
    ...
    public struct TransferCall: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateTransferCallToolDtoMessagesItem]?
        ...
        public let destinations: [UpdateTransferCallToolDtoDestinationsItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateTransferCallToolDtoMessagesItem]? = nil,
            destinations: [UpdateTransferCallToolDtoDestinationsItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateTransferCallToolDtoMessagesItem].self, forKey: .messages)
            self.destinations = try container.decodeIfPresent([UpdateTransferCallToolDtoDestinationsItem].self, forKey: .destinations)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct Handoff: Codable, Hashable, Sendable {
        ...
        public let destinations: [UpdateHandoffToolDtoDestinationsItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
    ...
    public struct Computer: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateComputerToolDtoMessagesItem]?
        /// The sub type of tool.
        ...
        public init(
            messages: [UpdateComputerToolDtoMessagesItem]? = nil,
            subType: Computer20241022? = nil,
            server: Server? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            name: Computer? = nil,
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateComputerToolDtoMessagesItem].self, forKey: .messages)
            self.subType = try container.decodeIfPresent(Computer20241022.self, forKey: .subType)
            self.server = try container.decodeIfPresent(Server.self, forKey: .server)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.name = try container.decodeIfPresent(Computer.self, forKey: .name)
    ...
    public struct TextEditor: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateTextEditorToolDtoMessagesItem]?
        /// The sub type of tool.
        ...
        public init(
            messages: [UpdateTextEditorToolDtoMessagesItem]? = nil,
            subType: TextEditor20241022? = nil,
            server: Server? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            name: StrReplaceEditor? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
            self.subType = subType
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateTextEditorToolDtoMessagesItem].self, forKey: .messages)
            self.subType = try container.decodeIfPresent(TextEditor20241022.self, forKey: .subType)
            self.server = try container.decodeIfPresent(Server.self, forKey: .server)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.name = try container.decodeIfPresent(StrReplaceEditor.self, forKey: .name)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct Query: Codable, Hashable, Sendable {
        ...
        public init(
            messages: [UpdateQueryToolDtoMessagesItem]? = nil,
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateQueryToolDtoMessagesItem].self, forKey: .messages)
    ...
    public struct GoogleCalendarEventCreate: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoogleCalendarCreateEventToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoogleCalendarCreateEventToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoogleCalendarCreateEventToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GoogleSheetsRowAppend: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoogleSheetsRowAppendToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoogleSheetsRowAppendToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoogleSheetsRowAppendToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GoogleCalendarAvailabilityCheck: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct SlackMessageSend: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateSlackSendMessageToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateSlackSendMessageToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateSlackSendMessageToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct Sms: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateSmsToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateSmsToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateSmsToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GohighlevelCalendarAvailabilityCheck: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GohighlevelCalendarEventCreate: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GohighlevelContactCreate: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoHighLevelContactCreateToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoHighLevelContactCreateToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoHighLevelContactCreateToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct GohighlevelContactGet: Codable, Hashable, Sendable {
        ...
        /// 
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        public let messages: [UpdateGoHighLevelContactGetToolDtoMessagesItem]?
        /// This is the plan to reject a tool call based on the conversation state.
        /// 
        /// // Example 1: Reject endCall if user didn't say goodbye
        /// ```json
        ...
        public init(
            messages: [UpdateGoHighLevelContactGetToolDtoMessagesItem]? = nil,
            rejectionPlan: ToolRejectionPlan? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.messages = messages
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.messages = try container.decodeIfPresent([UpdateGoHighLevelContactGetToolDtoMessagesItem].self, forKey: .messages)
            self.rejectionPlan = try container.decodeIfPresent(ToolRejectionPlan.self, forKey: .rejectionPlan)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
