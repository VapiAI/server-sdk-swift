...
public struct CreateWebChatDto: Codable, Hashable, Sendable {
    ...
    public let input: CreateWebChatDtoInput
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.input = try container.decode(CreateWebChatDtoInput.self, forKey: .input)
