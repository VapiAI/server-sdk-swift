...
public struct AssistantOverrides: Codable, Hashable, Sendable {
    ...
    public let model: AssistantOverridesModel?
    /// These are the options for the assistant's voice.
    public let voice: AssistantOverridesVoice?
    ...
    public let firstMessageMode: AssistantOverridesFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// This uses Twilio's built-in detection while the VoicemailTool relies on the model to detect if a voicemail was reached.
    /// You can use neither of them, one of them, or both of them. By default, Twilio built-in detection is enabled while VoicemailTool is not.
    public let voicemailDetection: AssistantOverridesVoicemailDetection?
    /// These are the messages that will be sent to your Client SDKs. Default is conversation-update,function-call,hang,model-output,speech-update,status-update,transfer-update,transcript,tool-calls,user-interrupted,voice-input,workflow.node.started. You can check the shape of the messages in ClientMessage schema.
    public let clientMessages: [AssistantOverridesClientMessagesItem]?
    ...
    public let serverMessages: [AssistantOverridesServerMessagesItem]?
    ...
    public let backgroundSound: AssistantOverridesBackgroundSound?
    ...
    public init(
        transcriber: AssistantOverridesTranscriber? = nil,
        model: AssistantOverridesModel? = nil,
        voice: AssistantOverridesVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: AssistantOverridesFirstMessageMode? = nil,
        voicemailDetection: AssistantOverridesVoicemailDetection? = nil,
        clientMessages: [AssistantOverridesClientMessagesItem]? = nil,
        serverMessages: [AssistantOverridesServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: AssistantOverridesBackgroundSound? = nil,
        ...
        credentials: [AssistantOverridesCredentialsItem]? = nil,
        hooks: [AssistantOverridesHooksItem]? = nil,
        toolsAppend: [AssistantOverridesToolsAppendItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(AssistantOverridesTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(AssistantOverridesModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(AssistantOverridesVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(AssistantOverridesFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(AssistantOverridesVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([AssistantOverridesClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([AssistantOverridesServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(AssistantOverridesBackgroundSound.self, forKey: .backgroundSound)
        ...
        self.credentials = try container.decodeIfPresent([AssistantOverridesCredentialsItem].self, forKey: .credentials)
        self.hooks = try container.decodeIfPresent([AssistantOverridesHooksItem].self, forKey: .hooks)
        self.toolsAppend = try container.decodeIfPresent([AssistantOverridesToolsAppendItem].self, forKey: .toolsAppend)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.toolsAppend, forKey: .toolsAppend)
