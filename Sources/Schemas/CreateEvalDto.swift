...
public struct CreateEvalDto: Codable, Hashable, Sendable {
    ...
    public let messages: [CreateEvalDtoMessagesItem]
    ...
    public let type: CreateEvalDtoType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.messages = try container.decode([CreateEvalDtoMessagesItem].self, forKey: .messages)
        self.name = try container.decodeIfPresent(String.self, forKey: .name)
        self.description = try container.decodeIfPresent(String.self, forKey: .description)
        self.type = try container.decode(CreateEvalDtoType.self, forKey: .type)
