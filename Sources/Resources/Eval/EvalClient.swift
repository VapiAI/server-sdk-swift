...
public final class EvalClient: Sendable {
    ...
    ///
    /// - Parameter search: Literal, case-insensitive search across eval and assistant names.
    ...
    /// - Parameter sortOrder: This is the sort order for pagination. Defaults to 'DESC'.
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func evalControllerGetRunsPaginated(sortBy: EvalControllerGetRunsPaginatedRequestSortBy? = nil, search: String? = nil, id: String? = nil, limit: Double? = nil, createdAtGt: Date? = nil, createdAtLt: Date? = nil, createdAtGe: Date? = nil, createdAtLe: Date? = nil, updatedAtGt: Date? = nil, updatedAtLt: Date? = nil, updatedAtGe: Date? = nil, updatedAtLe: Date? = nil, page: Double? = nil, sortOrder: EvalControllerGetRunsPaginatedRequestSortOrder? = nil, requestOptions: RequestOptions? = nil) async throws -> EvalRunPaginatedResponse {
        return try await httpClient.performRequest(
            method: .get,
            path: "/eval/run",
            queryParams: [
