...
public struct OpenAiModel: Codable, Hashable, Sendable {
    ...
    public let speaker: OpenAiSpeaker?
    /// Configuration for the reasoner supporting the GPT-Live speaker.
    public let reasoner: OpenAiReasoner?
    ...
    public let serviceTier: OpenAiModelServiceTier?
    ...
    public init(
        ...
        speaker: OpenAiSpeaker? = nil,
        reasoner: OpenAiReasoner? = nil,
        ...
        serviceTier: OpenAiModelServiceTier? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.speaker = try container.decodeIfPresent(OpenAiSpeaker.self, forKey: .speaker)
        self.reasoner = try container.decodeIfPresent(OpenAiReasoner.self, forKey: .reasoner)
        ...
        self.serviceTier = try container.decodeIfPresent(OpenAiModelServiceTier.self, forKey: .serviceTier)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.reasoner, forKey: .reasoner)
