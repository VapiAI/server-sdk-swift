...
extension Requests {
    public struct CreateChatDto: Codable, Hashable, Sendable {
        ...
        public let input: CreateChatDtoInput
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.input = try container.decode(CreateChatDtoInput.self, forKey: .input)
