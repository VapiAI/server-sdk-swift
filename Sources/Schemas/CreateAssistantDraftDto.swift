...
public struct CreateAssistantDraftDto: Codable, Hashable, Sendable {
    /// These are the options for the assistant's transcriber.
    public let transcriber: CreateAssistantDraftDtoTranscriber?
    /// These are the options for the assistant's LLM.
    public let model: CreateAssistantDraftDtoModel?
    /// These are the options for the assistant's voice.
    public let voice: CreateAssistantDraftDtoVoice?
    ...
    public let firstMessageMode: CreateAssistantDraftDtoFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// By default, voicemail detection is disabled.
    public let voicemailDetection: CreateAssistantDraftDtoVoicemailDetection?
    ...
    public let clientMessages: [CreateAssistantDraftDtoClientMessagesItem]?
    ...
    public let serverMessages: [CreateAssistantDraftDtoServerMessagesItem]?
    ...
    public let backgroundSound: CreateAssistantDraftDtoBackgroundSound?
    ...
    public let credentials: [CreateAssistantDraftDtoCredentialsItem]?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [CreateAssistantDraftDtoHooksItem]?
    ...
    public init(
        transcriber: CreateAssistantDraftDtoTranscriber? = nil,
        model: CreateAssistantDraftDtoModel? = nil,
        voice: CreateAssistantDraftDtoVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: CreateAssistantDraftDtoFirstMessageMode? = nil,
        voicemailDetection: CreateAssistantDraftDtoVoicemailDetection? = nil,
        clientMessages: [CreateAssistantDraftDtoClientMessagesItem]? = nil,
        serverMessages: [CreateAssistantDraftDtoServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: CreateAssistantDraftDtoBackgroundSound? = nil,
        ...
        credentials: [CreateAssistantDraftDtoCredentialsItem]? = nil,
        hooks: [CreateAssistantDraftDtoHooksItem]? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(CreateAssistantDraftDtoTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(CreateAssistantDraftDtoModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(CreateAssistantDraftDtoVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(CreateAssistantDraftDtoFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(CreateAssistantDraftDtoVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([CreateAssistantDraftDtoClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([CreateAssistantDraftDtoServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(CreateAssistantDraftDtoBackgroundSound.self, forKey: .backgroundSound)
        ...
        self.credentials = try container.decodeIfPresent([CreateAssistantDraftDtoCredentialsItem].self, forKey: .credentials)
        self.hooks = try container.decodeIfPresent([CreateAssistantDraftDtoHooksItem].self, forKey: .hooks)
