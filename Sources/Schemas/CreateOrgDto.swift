...
public struct CreateOrgDto: Codable, Hashable, Sendable {
    ...
    public let channel: CreateOrgDtoChannel?
    ...
    public init(
        ...
        name: String? = nil,
        channel: CreateOrgDtoChannel? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.channel = try container.decodeIfPresent(CreateOrgDtoChannel.self, forKey: .channel)
