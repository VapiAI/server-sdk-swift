...
public struct CodeTool: Codable, Hashable, Sendable {
    /// These are the messages that will be spoken to the user as the tool is running.
    /// 
    /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
    public let messages: [CodeToolMessagesItem]?
    ...
    public init(
        messages: [CodeToolMessagesItem]? = nil,
        async: Bool? = nil,
        server: Server? = nil,
        code: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.messages = try container.decodeIfPresent([CodeToolMessagesItem].self, forKey: .messages)
