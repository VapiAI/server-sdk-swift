...
public struct PieInsight: Codable, Hashable, Sendable {
    ...
    public let groupBy: PieInsightGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [PieInsightQueriesItem]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(PieInsightGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([PieInsightQueriesItem].self, forKey: .queries)
