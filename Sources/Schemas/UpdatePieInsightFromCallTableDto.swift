...
public struct UpdatePieInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let groupBy: UpdatePieInsightFromCallTableDtoGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [UpdatePieInsightFromCallTableDtoQueriesItem]?
    ...
    public init(
        ...
        groupBy: UpdatePieInsightFromCallTableDtoGroupBy? = nil,
        queries: [UpdatePieInsightFromCallTableDtoQueriesItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(UpdatePieInsightFromCallTableDtoGroupBy.self, forKey: .groupBy)
        self.queries = try container.decodeIfPresent([UpdatePieInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
