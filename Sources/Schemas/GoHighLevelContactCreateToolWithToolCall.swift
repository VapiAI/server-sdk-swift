...
public struct GoHighLevelContactCreateToolWithToolCall: Codable, Hashable, Sendable {
    /// These are the messages that will be spoken to the user as the tool is running.
    /// 
    /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
    public let messages: [GoHighLevelContactCreateToolWithToolCallMessagesItem]?
    /// The type of tool. "gohighlevel.contact.create" for GoHighLevel Contact Create tool.
    public let type: GohighlevelContactCreate
    ...
    public init(
        messages: [GoHighLevelContactCreateToolWithToolCallMessagesItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.messages = try container.decodeIfPresent([GoHighLevelContactCreateToolWithToolCallMessagesItem].self, forKey: .messages)
        self.type = try container.decode(GohighlevelContactCreate.self, forKey: .type)
    ...
    public enum GohighlevelContactCreate: String, Codable, Hashable, CaseIterable, Sendable {
