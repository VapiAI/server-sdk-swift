...
public enum FallbackTranscriberPlanTranscribersItem: Codable, Hashable, Sendable {
    ...
    public struct Gladia: Codable, Hashable, Sendable {
        ...
        public let languageBehaviour: FallbackGladiaTranscriberLanguageBehaviour?
        ...
        public let region: FallbackGladiaTranscriberRegion?
        ...
        public init(
            ...
            region: FallbackGladiaTranscriberRegion? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.region = try container.decodeIfPresent(FallbackGladiaTranscriberRegion.self, forKey: .region)
    ...
    public struct Google: Codable, Hashable, Sendable {
        ...
        /// This is the language that will be set for the transcription.
        public let language: FallbackGoogleTranscriberLanguage?
        /// Additional properties that are not explicitly defined in the schema
        public let additionalProperties: [String: JSONValue]

        public init(
            model: FallbackGoogleTranscriberModel? = nil,
            language: FallbackGoogleTranscriberLanguage? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.model = model
            self.language = language
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.model = try container.decodeIfPresent(FallbackGoogleTranscriberModel.self, forKey: .model)
            self.language = try container.decodeIfPresent(FallbackGoogleTranscriberLanguage.self, forKey: .language)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
    ...
    public struct Openai: Codable, Hashable, Sendable {
        ...
        /// This is the language that will be set for the transcription.
        public let language: FallbackOpenAiTranscriberLanguage?
        /// Additional properties that are not explicitly defined in the schema
        public let additionalProperties: [String: JSONValue]

        public init(
            model: FallbackOpenAiTranscriberModel,
            language: FallbackOpenAiTranscriberLanguage? = nil,
            additionalProperties: [String: JSONValue] = .init()
        ) {
            self.model = model
            self.language = language
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: CodingKeys.self)
            self.model = try container.decode(FallbackOpenAiTranscriberModel.self, forKey: .model)
            self.language = try container.decodeIfPresent(FallbackOpenAiTranscriberLanguage.self, forKey: .language)
            self.additionalProperties = try decoder.decodeAdditionalProperties(using: CodingKeys.self)
        }
