...
public struct CreateOutboundCallDto: Codable, Hashable, Sendable {
    ...
    public let transport: CreateOutboundCallDtoTransport?
    ...
    public init(
        ...
        transport: CreateOutboundCallDtoTransport? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transport = try container.decodeIfPresent(CreateOutboundCallDtoTransport.self, forKey: .transport)
