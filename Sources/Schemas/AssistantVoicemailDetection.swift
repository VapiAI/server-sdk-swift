...
public enum AssistantVoicemailDetection: Codable, Hashable, Sendable {
    case assistantVoicemailDetectionZero(AssistantVoicemailDetectionZero)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(AssistantVoicemailDetectionZero.self) {
            self = .assistantVoicemailDetectionZero(value)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        switch self {
        case .assistantVoicemailDetectionZero(let value):
