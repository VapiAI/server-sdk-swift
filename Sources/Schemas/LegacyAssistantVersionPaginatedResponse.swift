...
public struct LegacyAssistantVersionPaginatedResponse: Codable, Hashable, Sendable {
    public let results: [LegacyAssistantVersion]
    ...
    public init(
        results: [LegacyAssistantVersion],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.results = try container.decode([LegacyAssistantVersion].self, forKey: .results)
