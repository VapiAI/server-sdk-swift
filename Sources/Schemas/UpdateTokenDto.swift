...
public struct UpdateTokenDto: Codable, Hashable, Sendable {
    /// This is the tag for the token. It represents its scope.
    public let tag: UpdateTokenDtoTag?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.tag = try container.decodeIfPresent(UpdateTokenDtoTag.self, forKey: .tag)
