...
public struct WorkflowAnthropicBedrockModel: Codable, Hashable, Sendable {
    /// This is the specific model that will be used.
    public let model: WorkflowAnthropicBedrockModelModel
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.model = try container.decode(WorkflowAnthropicBedrockModelModel.self, forKey: .model)
