...
public struct CreateTestSuiteTestChatDto: Codable, Hashable, Sendable {
    /// These are the scorers used to evaluate the test.
    public let scorers: [TestSuiteTestScorerAi]
    /// This is the type of the test, which must be chat.
    public let type: CreateTestSuiteTestChatDtoType
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(CreateTestSuiteTestChatDtoType.self, forKey: .type)
