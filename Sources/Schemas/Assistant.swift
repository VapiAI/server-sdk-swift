...
public struct Assistant: Codable, Hashable, Sendable {
    ...
    public let voice: AssistantVoice?
    ...
    public let firstMessageMode: AssistantFirstMessageMode?
    /// These are the settings to configure or disable voicemail detection. Alternatively, voicemail detection can be configured using the model.tools=[VoicemailTool].
    /// This uses Twilio's built-in detection while the VoicemailTool relies on the model to detect if a voicemail was reached.
    /// You can use neither of them, one of them, or both of them. By default, Twilio built-in detection is enabled while VoicemailTool is not.
    public let voicemailDetection: AssistantVoicemailDetection?
    /// These are the messages that will be sent to your Client SDKs. Default is conversation-update,function-call,hang,model-output,speech-update,status-update,transfer-update,transcript,tool-calls,user-interrupted,voice-input,workflow.node.started. You can check the shape of the messages in ClientMessage schema.
    public let clientMessages: [AssistantClientMessagesItem]?
    ...
    public let serverMessages: [AssistantServerMessagesItem]?
    ...
    public let backgroundSound: AssistantBackgroundSound?
    ...
    public init(
        transcriber: AssistantTranscriber? = nil,
        model: AssistantModel? = nil,
        voice: AssistantVoice? = nil,
        firstMessage: String? = nil,
        firstMessageInterruptionsEnabled: Bool? = nil,
        firstMessageMode: AssistantFirstMessageMode? = nil,
        voicemailDetection: AssistantVoicemailDetection? = nil,
        clientMessages: [AssistantClientMessagesItem]? = nil,
        serverMessages: [AssistantServerMessagesItem]? = nil,
        maxDurationSeconds: Double? = nil,
        backgroundSound: AssistantBackgroundSound? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.transcriber = try container.decodeIfPresent(AssistantTranscriber.self, forKey: .transcriber)
        self.model = try container.decodeIfPresent(AssistantModel.self, forKey: .model)
        self.voice = try container.decodeIfPresent(AssistantVoice.self, forKey: .voice)
        ...
        self.firstMessageMode = try container.decodeIfPresent(AssistantFirstMessageMode.self, forKey: .firstMessageMode)
        self.voicemailDetection = try container.decodeIfPresent(AssistantVoicemailDetection.self, forKey: .voicemailDetection)
        self.clientMessages = try container.decodeIfPresent([AssistantClientMessagesItem].self, forKey: .clientMessages)
        self.serverMessages = try container.decodeIfPresent([AssistantServerMessagesItem].self, forKey: .serverMessages)
        self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
        self.backgroundSound = try container.decodeIfPresent(AssistantBackgroundSound.self, forKey: .backgroundSound)
