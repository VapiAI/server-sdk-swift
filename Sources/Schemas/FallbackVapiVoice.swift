...
public struct FallbackVapiVoice: Codable, Hashable, Sendable {
    ...
    public let version: FallbackVapiVoiceVersion?
    ...
    public let language: FallbackVapiVoiceLanguage?
    ...
    public init(
        ...
        voiceId: String,
        version: FallbackVapiVoiceVersion? = nil,
        speed: Double? = nil,
        language: FallbackVapiVoiceLanguage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.version = try container.decodeIfPresent(FallbackVapiVoiceVersion.self, forKey: .version)
        self.speed = try container.decodeIfPresent(Double.self, forKey: .speed)
        self.language = try container.decodeIfPresent(FallbackVapiVoiceLanguage.self, forKey: .language)
