...
public struct GoogleVoicemailDetectionPlan: Codable, Hashable, Sendable {
    ...
    public let provider: GoogleVoicemailDetectionPlanProvider
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.provider = try container.decode(GoogleVoicemailDetectionPlanProvider.self, forKey: .provider)
