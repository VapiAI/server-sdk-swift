...
public struct UpdateTextInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let queries: [UpdateTextInsightFromCallTableDtoQueriesItem]?
    ...
    public init(
        ...
        queries: [UpdateTextInsightFromCallTableDtoQueriesItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.queries = try container.decodeIfPresent([UpdateTextInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
