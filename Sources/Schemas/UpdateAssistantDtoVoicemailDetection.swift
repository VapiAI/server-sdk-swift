...
public enum UpdateAssistantDtoVoicemailDetection: Codable, Hashable, Sendable {
    ...
    case updateAssistantDtoVoicemailDetectionZero(UpdateAssistantDtoVoicemailDetectionZero)
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if let value = try? container.decode(UpdateAssistantDtoVoicemailDetectionZero.self) {
            self = .updateAssistantDtoVoicemailDetectionZero(value)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        case .twilioVoicemailDetectionPlan(let value):
            try container.encode(value)
        case .updateAssistantDtoVoicemailDetectionZero(let value):
            try container.encode(value)
