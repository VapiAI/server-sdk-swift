...
public struct MakeTool: Codable, Hashable, Sendable {
    /// These are the messages that will be spoken to the user as the tool is running.
    /// 
    /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
    public let messages: [MakeToolMessagesItem]?
    /// The type of tool. "make" for Make tool.
    public let type: MakeToolType
    ...
    public init(
        messages: [MakeToolMessagesItem]? = nil,
        type: MakeToolType,
        id: String,
        orgId: String,
        createdAt: Date,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.messages = try container.decodeIfPresent([MakeToolMessagesItem].self, forKey: .messages)
        self.type = try container.decode(MakeToolType.self, forKey: .type)
