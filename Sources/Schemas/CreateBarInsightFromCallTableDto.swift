...
public struct CreateBarInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let groupBy: CreateBarInsightFromCallTableDtoGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [CreateBarInsightFromCallTableDtoQueriesItem]
    ...
    public init(
        ...
        groupBy: CreateBarInsightFromCallTableDtoGroupBy? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(CreateBarInsightFromCallTableDtoGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([CreateBarInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
