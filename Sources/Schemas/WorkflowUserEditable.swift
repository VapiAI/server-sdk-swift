...
public struct WorkflowUserEditable: Codable, Hashable, Sendable {
    ...
    public let backgroundSound: WorkflowUserEditableBackgroundSound?
    /// This is a set of actions that will be performed on certain events.
    public let hooks: [WorkflowUserEditableHooksItem]?
    ...
    public let credentials: [WorkflowUserEditableCredentialsItem]?
    /// This is the voicemail detection plan for the workflow.
    public let voicemailDetection: WorkflowUserEditableVoicemailDetection?
    ...
    public init(
        ...
        model: WorkflowUserEditableModel? = nil,
        transcriber: WorkflowUserEditableTranscriber? = nil,
        voice: WorkflowUserEditableVoice? = nil,
        observabilityPlan: LangfuseObservabilityPlan? = nil,
        backgroundSound: WorkflowUserEditableBackgroundSound? = nil,
        hooks: [WorkflowUserEditableHooksItem]? = nil,
        credentials: [WorkflowUserEditableCredentialsItem]? = nil,
        voicemailDetection: WorkflowUserEditableVoicemailDetection? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.nodes = try container.decode([WorkflowUserEditableNodesItem].self, forKey: .nodes)
        self.model = try container.decodeIfPresent(WorkflowUserEditableModel.self, forKey: .model)
        self.transcriber = try container.decodeIfPresent(WorkflowUserEditableTranscriber.self, forKey: .transcriber)
        self.voice = try container.decodeIfPresent(WorkflowUserEditableVoice.self, forKey: .voice)
        self.observabilityPlan = try container.decodeIfPresent(LangfuseObservabilityPlan.self, forKey: .observabilityPlan)
        self.backgroundSound = try container.decodeIfPresent(WorkflowUserEditableBackgroundSound.self, forKey: .backgroundSound)
        self.hooks = try container.decodeIfPresent([WorkflowUserEditableHooksItem].self, forKey: .hooks)
        self.credentials = try container.decodeIfPresent([WorkflowUserEditableCredentialsItem].self, forKey: .credentials)
        self.voicemailDetection = try container.decodeIfPresent(WorkflowUserEditableVoicemailDetection.self, forKey: .voicemailDetection)
