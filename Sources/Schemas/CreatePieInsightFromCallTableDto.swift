...
public struct CreatePieInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let groupBy: CreatePieInsightFromCallTableDtoGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [CreatePieInsightFromCallTableDtoQueriesItem]
    ...
    public init(
        ...
        groupBy: CreatePieInsightFromCallTableDtoGroupBy? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(CreatePieInsightFromCallTableDtoGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([CreatePieInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
