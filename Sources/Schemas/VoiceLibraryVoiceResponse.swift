...
public struct VoiceLibraryVoiceResponse: Codable, Hashable, Sendable {
    public let age: VoiceLibraryVoiceResponseAge?
    ...
    public init(
        age: VoiceLibraryVoiceResponseAge? = nil,
        voiceId: String,
        name: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.age = try container.decodeIfPresent(VoiceLibraryVoiceResponseAge.self, forKey: .age)
