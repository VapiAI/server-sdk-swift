...
public enum ClientMessageMessage: Codable, Hashable, Sendable {
    case clientMessageAssistantSpeech(ClientMessageAssistantSpeech)
    case clientMessageAssistantStarted(ClientMessageAssistantStarted)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(ClientMessageAssistantSpeech.self) {
            self = .clientMessageAssistantSpeech(value)
        } else if let value = try? container.decode(ClientMessageAssistantStarted.self) {
            self = .clientMessageAssistantStarted(value)
        ...
        } else if let value = try? container.decode(ClientMessageWorkflowNodeStarted.self) {
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        switch self {
        case .clientMessageAssistantSpeech(let value):
            try container.encode(value)
        case .clientMessageAssistantStarted(let value):
            try container.encode(value)
