...
public enum AssistantDraftVoicemailDetection: Codable, Hashable, Sendable {
    case assistantDraftVoicemailDetectionZero(AssistantDraftVoicemailDetectionZero)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(AssistantDraftVoicemailDetectionZero.self) {
            self = .assistantDraftVoicemailDetectionZero(value)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        switch self {
        case .assistantDraftVoicemailDetectionZero(let value):
