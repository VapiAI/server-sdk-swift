...
public enum AssistantVersionVoicemailDetection: Codable, Hashable, Sendable {
    case assistantVersionVoicemailDetectionZero(AssistantVersionVoicemailDetectionZero)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(AssistantVersionVoicemailDetectionZero.self) {
            self = .assistantVersionVoicemailDetectionZero(value)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        switch self {
        case .assistantVersionVoicemailDetectionZero(let value):
