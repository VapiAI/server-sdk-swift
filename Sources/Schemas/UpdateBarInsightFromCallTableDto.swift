...
public struct UpdateBarInsightFromCallTableDto: Codable, Hashable, Sendable {
    ...
    public let groupBy: UpdateBarInsightFromCallTableDtoGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [UpdateBarInsightFromCallTableDtoQueriesItem]?
    ...
    public init(
        ...
        groupBy: UpdateBarInsightFromCallTableDtoGroupBy? = nil,
        queries: [UpdateBarInsightFromCallTableDtoQueriesItem]? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(UpdateBarInsightFromCallTableDtoGroupBy.self, forKey: .groupBy)
        self.queries = try container.decodeIfPresent([UpdateBarInsightFromCallTableDtoQueriesItem].self, forKey: .queries)
