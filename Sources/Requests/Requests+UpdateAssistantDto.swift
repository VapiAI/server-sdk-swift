...
extension Requests {
    public struct UpdateAssistantDto: Codable, Hashable, Sendable {
        /// These are the options for the assistant's transcriber.
        public let transcriber: UpdateAssistantDtoTranscriber?
        /// These are the options for the assistant's LLM.
        public let model: UpdateAssistantDtoModel?
        /// These are the options for the assistant's voice.
        public let voice: UpdateAssistantDtoVoice?
        ...
        public let credentials: [UpdateAssistantDtoCredentialsItem]?
        /// This is a set of actions that will be performed on certain events.
        public let hooks: [UpdateAssistantDtoHooksItem]?
        ...
        public init(
            transcriber: UpdateAssistantDtoTranscriber? = nil,
            model: UpdateAssistantDtoModel? = nil,
            voice: UpdateAssistantDtoVoice? = nil,
            firstMessage: String? = nil,
            firstMessageInterruptionsEnabled: Bool? = nil,
            firstMessageMode: UpdateAssistantDtoFirstMessageMode? = nil,
            voicemailDetection: UpdateAssistantDtoVoicemailDetection? = nil,
            clientMessages: [UpdateAssistantDtoClientMessagesItem]? = nil,
            serverMessages: [UpdateAssistantDtoServerMessagesItem]? = nil,
            maxDurationSeconds: Double? = nil,
            backgroundSound: UpdateAssistantDtoBackgroundSound? = nil,
            ...
            credentials: [UpdateAssistantDtoCredentialsItem]? = nil,
            hooks: [UpdateAssistantDtoHooksItem]? = nil,
            name: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.transcriber = try container.decodeIfPresent(UpdateAssistantDtoTranscriber.self, forKey: .transcriber)
            self.model = try container.decodeIfPresent(UpdateAssistantDtoModel.self, forKey: .model)
            self.voice = try container.decodeIfPresent(UpdateAssistantDtoVoice.self, forKey: .voice)
            ...
            self.firstMessageMode = try container.decodeIfPresent(UpdateAssistantDtoFirstMessageMode.self, forKey: .firstMessageMode)
            self.voicemailDetection = try container.decodeIfPresent(UpdateAssistantDtoVoicemailDetection.self, forKey: .voicemailDetection)
            self.clientMessages = try container.decodeIfPresent([UpdateAssistantDtoClientMessagesItem].self, forKey: .clientMessages)
            self.serverMessages = try container.decodeIfPresent([UpdateAssistantDtoServerMessagesItem].self, forKey: .serverMessages)
            self.maxDurationSeconds = try container.decodeIfPresent(Double.self, forKey: .maxDurationSeconds)
            self.backgroundSound = try container.decodeIfPresent(UpdateAssistantDtoBackgroundSound.self, forKey: .backgroundSound)
            ...
            self.credentials = try container.decodeIfPresent([UpdateAssistantDtoCredentialsItem].self, forKey: .credentials)
            self.hooks = try container.decodeIfPresent([UpdateAssistantDtoHooksItem].self, forKey: .hooks)
