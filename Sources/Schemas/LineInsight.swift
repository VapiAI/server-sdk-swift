...
public struct LineInsight: Codable, Hashable, Sendable {
    ...
    public let groupBy: LineInsightGroupBy?
    /// These are the queries to run to generate the insight.
    public let queries: [LineInsightQueriesItem]
    ...
    public init(
        ...
        groupBy: LineInsightGroupBy? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.groupBy = try container.decodeIfPresent(LineInsightGroupBy.self, forKey: .groupBy)
        self.queries = try container.decode([LineInsightQueriesItem].self, forKey: .queries)
