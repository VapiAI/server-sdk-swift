...
public struct TextInsightFromCallTable: Codable, Hashable, Sendable {
    /// This is the name of the Insight.
    public let name: String?
    /// This is the type of the Insight.
    /// It is required to be `text` to create a text insight.
    public let type: TextInsightFromCallTableType
    ...
    public let queries: [TextInsightFromCallTableQueriesItem]
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(TextInsightFromCallTableType.self, forKey: .type)
        ...
        self.queries = try container.decode([TextInsightFromCallTableQueriesItem].self, forKey: .queries)
